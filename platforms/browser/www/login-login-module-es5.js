            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    loginParameters = new _ionic_native_unvired_cordova_sdk_ngx__WEBPACK_IMPORTED_MODULE_4__["LoginParameters"](); // loginParameters.appName = AppConstant.APPLICATION_NAME;
                    ...
                    loginParameters.loginType = _ionic_native_unvired_cordova_sdk_ngx__WEBPACK_IMPORTED_MODULE_4__["LoginType"].unvired; // let loginResult: LoginResult;
                    // try {
